#pragma checksum "D:\OnCallGit\OnCall.Web\Views\Systems\SysAlarmLevel\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "be3454dc073a7804b194f680dcb4c8bb8f6e4093"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"be3454dc073a7804b194f680dcb4c8bb8f6e4093", @"/Views/Systems/SysAlarmLevel/Index.cshtml")]
    ...
    public class Views_Systems_SysAlarmLevel_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "D:\OnCallGit\OnCall.Web\Views\Systems\SysAlarmLevel\Index.cshtml"
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "be3454dc073a7804b194f680dcb4c8bb8f6e40933858", async() => {
                BeginContext(58, 41, true);
                WriteLiteral("\r\n    <meta charset=\"utf-8\">\r\n    <title>");
                EndContext();
                BeginContext(100, 16, false);
#line 8 "D:\OnCallGit\OnCall.Web\Views\Systems\SysAlarmLevel\Index.cshtml"
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "be3454dc073a7804b194f680dcb4c8bb8f6e40935848", async() => {
    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , { field: 'AlarmLeve");
            WriteLiteral(@"l', width: 150, title: '告警级别', sort: true }
                , {
        ...
        //监听表格复选框选择
      ");
            WriteLiteral(@"  table.on('checkbox(table-page)', function (obj) {
            console.log(obj)
        });
        //监听工具条
                ...
                layer.confirm('确定删除[{0}]吗?'.format(idNames.join(',')), function (index) {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status) {
                                layui.table.");
            WriteLiteral(@"reload('table-page');
                                layer.close(index);
                            } else {
